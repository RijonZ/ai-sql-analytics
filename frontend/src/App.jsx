      ...
      <div style={styles.main}>
        ...
        {history.length > 0 && !result && !loading && !error && (
          <div style={styles.historySection}>
            ...
            {history.map((h, i) => (
              <button key={i} style={styles.historyItem} onClick={() => handleQuery(h.question)}>
...
const styles = {
  ...
  historyItem: { width: '100%', background: '#1a1d27', border: '1px solid #2d3148', borderRadius: 8, padding: '0.65rem 1rem', color: '#e2e8f0', cursor: 'pointer', display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.4rem', fontSize: '0.88rem', fontFamily: 'inherit', textAlign: 'left' },
  historyQ: { flex: 1 },
